 <!-- delete_modal_Grade -->
 <div class="modal fade" id="delete{{ $dropdownlist->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('Delete_dropdownlistelement') }}" method="post">
                                                @csrf
                                                {{ trans('serviceattribute_trans.Warning_Delete') }}

                                                <input id="Name" type="text" name="Name"
                                                                   class="form-control"
                                                                   value="{{$dropdownlist->selecttype_elements->name }} {{ $dropdownlist->name }}"
                                                                   disabled>
