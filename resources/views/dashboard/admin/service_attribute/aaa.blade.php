    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button"  class="button x-small" id="btn_delete_all">
                {{ trans('My_Classes_trans.CheckBoxDeleteAll') }}
            </button>
            ...
            <form action="{{ route('Filter_Classes') }}" method="POST">
                {{ csrf_field() }}
                <select class="form-select" style="width:140px" data-style="btn-info" name="Grade_id" required
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('Classroom.destroy', 'test') }}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
                                                {{ trans('messages_trans.Warning_Grade') }}
