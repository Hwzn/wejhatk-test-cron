                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                    ...
                                                    {{ trans('ads_trans.Edit_Attribute') }}
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('update_adsattr')}}" method="POST">
                                                   @csrf
                                                    <div class="row">
                                                <div class="col">
                                                    <label for="Name"
                                                        class="mr-sm-2">{{ trans('ads_trans.AttributeName_ar') }}
                                                        :</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en"
                                                        class="mr-sm-2">{{ trans('ads_trans.AttributeName_en') }}
                                                        :</label>
