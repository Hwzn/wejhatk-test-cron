<!-- add_modal_class -->
<div class="modal fade" id="edit_adslistModola" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{route('updated_adslist')}}" method="POST">
                    @csrf
