<div class="modal fade" id="deletesocialModola_ads" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                    ...
                                                    {{ trans('ads_trans.delete_socailmediatype') }}
                                                </h3>
                                            ...
                                            <div class="form-header">
                                                ...
                                                <div class="modal-btn delete-action">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <a href="javascript:void(0);" class="btn btn-primary ads-btn-del">{{__('ads_trans.Delete')}}</a>
                                                        </div>
                                                        <div class="col-6">
