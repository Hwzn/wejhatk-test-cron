...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>School System | New User </title>
...
<!--end check Save Data-->
  ...
  <form class="form" action="{{url('/postregister')}}" method="post">
              ...
              @csrf
				...
				<div class="pb-13 pt-lg-0 pt-5">
                  ...
                  -->
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										<label class="font-size-h6 font-weight-bolder text-dark pt-5">Re-Password</label>
									</div>
                  ...
                  <input class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" type="submit" value="Register" />
