       ...
       if($request->guardkey=='user_1')
       {
        try{
            //valdtion
             ...
             $token=Auth::guard('api')->attempt($credantionals);
           ...
           if($user->verified_at==Null)
            {
             ...
             $user->expires_in= auth()->factory()->getTTL() * 80423200;
             $user->guardkey='user_1';
       ...
       elseif($request->guardkey=='tripagent_1')
       {
        try{
           ...
           if($tripagent->verified_at==Null)
            {
             ...
             $tripagent->expires_in= auth()->factory()->getTTL() * 80423200;
         ...
         //send device token
          ...
          //send device token
       //   return response()->json('fff');
       $userdata['id']=$tripagent['id'];
       $userdata['name']=$tripagent['name'];
       $userdata['phone']=$tripagent['phone'];
       $userdata['verified_at']=$tripagent['verified_at'];
       $userdata['photo']=$tripagent['photo'];
       $userdata['created_at']=$tripagent['created_at'];
       $userdata['updated_at']=$tripagent['updated_at'];
       $userdata['api_token']=$tripagent['api_token'];
       $userdata['expires_in']=$tripagent['expires_in'];
       $userdata['guardkey']=$tripagent['guardkey'];
       ...
       elseif($request->guardkey=='tourguide_1')
       {
        ...
        try{
           ...
           if($tourguide->verified_at==Null)
            {
             ...
             $tourguide->expires_in= auth()->factory()->getTTL() * 80423200;
         ...
         //send device token
          ...
          //send device token
       //   return response()->json('fff');
       $userdata['id']=$tourguide['id'];
       $userdata['name']=$tourguide['name'];
       $userdata['phone']=$tourguide['phone'];
       $userdata['verified_at']=$tourguide['verified_at'];
       $userdata['photo']=$tourguide['photo'];
       $userdata['created_at']=$tourguide['created_at'];
       $userdata['updated_at']=$tourguide['updated_at'];
       $userdata['api_token']=$tourguide['api_token'];
       $userdata['expires_in']=$tourguide['expires_in'];
       $userdata['guardkey']=$tourguide['guardkey'];
             return response()->json(['User_data' => $userdata], 200);
