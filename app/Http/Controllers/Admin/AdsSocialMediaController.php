...
class AdsSocialMediaController extends Controller
{
   ...
   {
       $ads=AdsRequests::where('adstype_id',1)->orderby('id','desc')->get();
       return view('dashboard.admin.ads.social_media.requests',compact('ads'));

   }
   public function view_adsattachment($filename)
   {
     return response()->download('assets/uploads/Ads/SocialMedia/'.$filename);
   ...
   public function update(Request $request)
   {
        ...
        [
            ...
            'ads_id'=>'required|exists:ads_socialmedia,id',
