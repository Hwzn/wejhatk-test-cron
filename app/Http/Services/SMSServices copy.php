   ...
   public function removeOtpCode($code)
    ...
    public function reset_password($code)
    {
        ...
        public function sendSms($phone,$message)
        {
            ...
            try{
                $username=966580141174;
                $password=225588;

                http://www.qyadat.com/sms/api/sendsms.php?username=$username&password=&message=$message
                 &numbers=@mobile&sender=DV-Itech&unicode=u&return=full;
            }
            catch(\Exception $ex)
            {
              return false;
